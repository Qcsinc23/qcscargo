        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Fast & Reliable Air Freight</p>
              </div>
            </div>
          ...
          <div>
            ...
            <nav className="space-y-2">
              <Link to="/shipping-calculator" className="block text-gray-400 hover:text-white transition-colors">
                Shipping Calculator
              </Link>
              ...
              <Link to="/business-services" className="block text-gray-400 hover:text-white transition-colors">
                Business Services
              </Link>
              <Link to="/service-areas" className="block text-gray-400 hover:text-white transition-colors">
                Service Areas
              </Link>
            </nav>
          </div>

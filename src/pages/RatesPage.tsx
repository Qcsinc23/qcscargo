    ...
    <div className="bg-white">
          ...
          <div className="container mx-auto px-4">
            ...
            {loading ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mt-4">Loading rate information...</p>
              </div>
            ) : (
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-blue-100">{destination.city_name} ({destination.airport_code})</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-sm text-blue-100">Transit Time</div>
                          ...
                          <div className="space-y-4">
                            <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-600">
                              <div className="flex items-center justify-between mb-2">
                                ...
                                <span className="text-sm text-blue-600">Base Rate</span>
                              </div>
            ...
            <div className="mt-12 bg-blue-50 p-8 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                <div>
                  <h4 className="font-medium mb-2 text-blue-900">Dimensional Weight</h4>
                  <p className="text-gray-700 mb-4">
                    Calculated as Length × Width × Height ÷ 166 (inches). Billable weight is the greater of actual or dimensional weight.
                  </p>
                  
                  <h4 className="font-medium mb-2 text-blue-900">Rate Validity</h4>
                ...
                <div>
                  ...
                  <h4 className="font-medium mb-2 text-blue-900">Not Included</h4>
                  <p className="text-gray-700">
                  ...
                  {additionalServices.map((service, index) => (
                    <div key={index} className="bg-white border border-gray-200 p-6 rounded-lg shadow-sm">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <span className="text-blue-600 font-bold whitespace-nowrap ml-4">{service.price}</span>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {volumeDiscounts.map((discount, index) => (
                    <div key={index} className="bg-white border-2 border-purple-200 p-6 rounded-lg text-center">
                      <div className="text-lg font-medium text-gray-900 mb-2">{discount.range}</div>
                ...
                {rateExamples.map((example, index) => (
                  <div key={index} className="bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden">
                    <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6">
                      ...
                      <p className="text-blue-100">{example.details}</p>
                    </div>
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="space-x-4">
            <button className="bg-yellow-500 text-blue-900 px-8 py-4 rounded-lg text-lg font-bold hover:bg-yellow-400 transition-colors">
              Calculate Rates Now
            </button>

        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-sophisticated-olive mb-6">
                  Our Story
                </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-sophisticated-blue-light p-6 rounded-lg text-center">
                  <div className="text-3xl font-bold text-sophisticated-blue mb-2">10+</div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              <div className="bg-sophisticated-blue-light w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Heart className="h-8 w-8 text-sophisticated-blue" />
              </div>
              <h3 className="text-2xl font-bold text-sophisticated-olive mb-4">Our Mission</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              ...
              <h3 className="text-2xl font-bold text-sophisticated-olive mb-4">Our Vision</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg text-center">
              ...
              <h3 className="text-2xl font-bold text-sophisticated-olive mb-4">Our Values</h3>
              <p className="text-gray-700">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-sophisticated-blue">
              <div className="flex items-center mb-4">
                <Shield className="h-6 w-6 text-sophisticated-blue mr-3" />
                <h3 className="text-lg font-semibold">24/7 Security</h3>
              </div>
              <p className="text-sophisticated-blueGray">
          ...
          <div className="mt-12 bg-sophisticated-blue-light p-8 rounded-xl">
            <div className="text-center mb-6">
              <h3 className="text-2xl font-semibold text-sophisticated-olive mb-2">Facility Address</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-lg text-center">
                <div className="bg-sophisticated-blue-light w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Users className="h-10 w-10 text-sophisticated-blue" />
                </div>
                <h3 className="text-xl font-bold text-sophisticated-olive mb-2">{member.name}</h3>
                <p className="text-sophisticated-blue font-semibold mb-2">{member.title}</p>
                <p className="text-sophisticated-blueGray text-sm mb-2">{member.experience}</p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-sophisticated-olive mb-8">
            ...
            <div className="space-y-8">
              {milestones.map((milestone, index) => (
                <div key={index} className="flex items-start">
                  <div className="bg-sophisticated-blue text-white w-16 h-16 rounded-full flex items-center justify-center font-bold text-lg mr-6 flex-shrink-0">
                    {milestone.year}
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-sophisticated-olive mb-2">{milestone.title}</h3>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="space-x-4">
            <Link 
              ...
              className="bg-yellow-500 text-sophisticated-blue px-8 py-4 rounded-lg text-lg font-bold hover:bg-yellow-400 transition-colors inline-block"
            >
              Get Your Quote Today
            </Link>
            <Link 
              to="/contact" 
              className="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-sophisticated-blue transition-colors inline-block"
            >
              Visit Our Facility
            </Link>
          </div>

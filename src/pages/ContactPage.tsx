          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-400">
                ...
                <a href="tel:201-249-0929" className="text-blue-600 font-semibold hover:text-blue-700">
              ...
              <div className="mt-8">
                <h3 className="text-2xl font-semibold text-gray-900 mb-4">Visit Our Facility</h3>

...
export default function BookingPage() {
  ...
  if (success && createdBooking) {
    return (
      <div className="min-h-screen bg-sophisticated-gray flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader>
            <CardTitle className="text-sophisticated-green flex items-center">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="bg-sophisticated-green/10 border border-sophisticated-green/30 rounded-lg p-4">
                <p className="text-sm text-sophisticated-green font-medium mb-2">
                  Booking ID: {createdBooking.id}
                </p>
                <div className="text-xs text-sophisticated-green space-y-1">
  ...
  return (
    <div className="min-h-screen bg-sophisticated-gray">
      <div className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <h1 className="text-3xl font-bold text-sophisticated-olive mt-4">Schedule Pickup/Drop-off</h1>
          <p className="text-sophisticated-blueGray mt-1">Book a convenient time slot for your shipment</p>
        </div>
      </div>
              ...
              <CardContent>
                {windowsLoading ? (
                  <div className="flex items-center justify-center py-8">
                    <Loader2 className="h-8 w-8 animate-spin text-sophisticated-blue" />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {availableWindows.map((window, index) => (
                      <button
                        ...
                        className={cn(
                          "p-4 border rounded-lg text-left transition-colors hover:border-sophisticated-blue",
                          formData.selected_window === window 
                            ? "border-sophisticated-blue bg-sophisticated-blue/10" 
                            : "border-sophisticated-gray/30 bg-white"
                        )}
                      >
                        <div className="flex items-center justify-between mb-2">
                          <span className="font-medium">{window.display}</span>
                          {formData.selected_window === window && (
                            <CheckCircle className="h-4 w-4 text-sophisticated-blue" />
                          )}
                        </div>
                        <div className="text-sm text-sophisticated-blueGray space-y-1">
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-lg font-medium text-sophisticated-olive mb-2">No Time Windows Available</h3>

        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h2 className="text-2xl font-semibold mb-6 flex items-center">
                <Package className="h-6 w-6 mr-3 text-indigo-700" />
                Shipment Details
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      className="flex-1 p-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600"
                      placeholder="Enter weight"
                    />
                    <select
                      value={weightUnit}
                      onChange={(e) => setWeightUnit(e.target.value as 'lbs' | 'kg')}
                      className="p-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600"
                    >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <label className="flex items-center p-3 border border-slate-300 rounded-lg cursor-pointer hover:bg-slate-50">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-slate-500">Regular processing</div>
                      </div>
                    </label>
                    <label className="flex items-center p-3 border border-slate-300 rounded-lg cursor-pointer hover:bg-slate-50">
                      <input
                      ...
                      <div>
                        ...
                        <div className="text-sm text-slate-500">+25% for faster delivery</div>
                      </div>
                    </label>
                  </div>
                </div>
                ...
                <div className="flex space-x-4">
                  <button
                    ...
                    disabled={loading}
                    className="flex-1 bg-indigo-700 text-white py-3 px-6 rounded-lg font-semibold hover:bg-indigo-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                    {loading ? (
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              {calculatedRate ? (
                <div className="space-y-6">
                  ...
                  <div className="bg-indigo-50 p-4 rounded-lg">
                    <div className="flex items-center mb-2">
                      <Plane className="h-5 w-5 text-indigo-700 mr-2" />
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-500 text-lg">Enter shipment details to calculate rates</p>
          ...
          <div className="mt-12 bg-white p-8 rounded-xl shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-medium mb-2 text-indigo-700">What's Included</h3>

        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="mb-4">
                <div className="text-2xl font-bold text-primary mb-2">Medical Supply Distributor</div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="mb-4">
                <div className="text-2xl font-bold text-primary mb-2">Electronics Retailer</div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="mb-4">
                <div className="text-2xl font-bold text-primary mb-2">Cultural Organization</div>

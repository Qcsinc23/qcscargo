            ...
            {volumeDiscounts.map((tier, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-lg border-2 border-green-200">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">{tier.range}</h3>
                  <div className="text-3xl font-bold text-green-600 mb-2">{tier.discount}</div>
                  <div className="text-sm text-gray-600">Potential Savings</div>
                  <div className="text-lg font-medium text-gray-900">{tier.savings}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-12 bg-white p-8 rounded-xl shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Net 15 payment terms for qualified business accounts</p>
              </div>
              <div className="text-center">
                <Users className="h-12 w-12 text-blue-600 mx-auto mb-4" />
                <h4 className="font-semibold mb-2">Dedicated Support</h4>
                <p className="text-gray-600 text-sm">Priority customer service and account management</p>
              </div>
              <div className="text-center">
                <Package className="h-12 w-12 text-blue-600 mx-auto mb-4" />
                <h4 className="font-semibold mb-2">Custom Solutions</h4>
                <p className="text-gray-600 text-sm">Tailored logistics solutions for unique requirements</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {industrySpecialties.map((industry, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-blue-600">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="mb-4">
                <div className="text-2xl font-bold text-blue-600 mb-2">Medical Supply Distributor</div>
                <div className="text-gray-600">Monthly shipments to 3 Caribbean countries</div>
              </div>
              ...
              <div className="text-sm text-blue-600 font-medium">15% volume discount • Net 15 terms</div>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="mb-4">
                <div className="text-2xl font-bold text-blue-600 mb-2">Electronics Retailer</div>
                <div className="text-gray-600">Regular shipments of consumer electronics</div>
              </div>
              <p className="text-gray-700 mb-4">
              ...
              <div className="text-sm text-blue-600 font-medium">Custom rates • Priority support</div>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="mb-4">
                <div className="text-2xl font-bold text-blue-600 mb-2">Cultural Organization</div>
                <div className="text-gray-600">Event supplies and educational materials</div>
              </div>
              <p className="text-gray-700 mb-4">
              ...
              <div className="text-sm text-blue-600 font-medium">Non-profit rates • Special handling</div>
            </div>
          </div>
        </div>
      </section>

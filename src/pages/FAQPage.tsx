        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-2xl mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 text-gray-900 rounded-lg text-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
            />
          </div>
        </div>
      </section>
            ...
            {filteredCategories.map((category) => (
              <div key={category.id} className="mb-8">
                ...
                <button
                  ...
                  className="w-full bg-blue-50 hover:bg-blue-100 p-6 rounded-lg border-2 border-blue-200 transition-colors mb-4 flex items-center justify-between"
                >
